...
export default async function Assets({searchParams}:Props){
  ...
  return <AppShell>
    ...
    <AssetWizard properties={ps.map(p=>({id:p.id,name:p.name,rooms:p.rooms}))} initialStep={quickstart?2:1}/>
