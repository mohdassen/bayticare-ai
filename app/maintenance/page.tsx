...
const styles=`.maintenanceItem{display:grid;grid-template-columns:1fr auto;gap:14px;align-items:center;padding:16px 0;border-bottom:1px solid #edf1ee}.maintenanceItem:last-child{border-bottom:0}.completeForm{display:flex;align-items:center;gap:8px}.completeForm input{width:120px;padding:9px 10px;border:1px solid #d9e3dc;border-radius:11px;background:#fbfdfb;outline:none}.completeForm input:focus{border-color:#72b593;box-shadow:0 0 0 3px rgba(15,106,72,.07)}@media(max-width:700px){.maintenanceItem{grid-template-columns:1fr}.completeForm{width:100%}.completeForm input{flex:1;width:auto}.completeForm .btn{white-space:nowrap}}`;
...
export default async function Maintenance(){
  ...
  return <AppShell><style>{styles}</style>
